...
class YOLOR(object):
    def __init__(self):
        max_size = 896
        ENGINE_PATH     = os.path.dirname(os.path.abspath(__file__))+'/engine/tomato1999_advance_fp16.trt'
...
class DepthImageHandler(object):
    def __init__(self):
        ...
        ENGINE_PATH     = os.path.dirname(os.path.abspath(__file__))+'/../yolor/engine/tomato_advance_fp16.trt'
    ...
    def publishTomatoPos3Array(self)-> None:
        ...
        for index in range(tomatoObject.number):
            ...
            if pos3[0] < 0.1 or pos3[0] > 0.8:
                continue
            if pos3[1] < 0.0 or pos3[1] > 0.8:
                continue
            if pos3[2] < 0.1 or pos3[2] > 0.8:
                continue

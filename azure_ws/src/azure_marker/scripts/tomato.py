...
class DepthImageHandler(object):
    ...
    def GetTomato(self):
        ...
        color_image = self.center_crop(color_image,[self.W//self.cropSize,self.H//self.cropSize])
        #print(color_image.shape)
        depthForCloud = depth_image
        # ================================================================================ CHANGED ============
        # converted to 16bit
        depth_image = depth_image.astype(np.uint16)
        depth_image = self.center_crop(depth_image,[self.W//self.cropSize,self.H//self.cropSize])

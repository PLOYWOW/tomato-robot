...
def  cameraSetting(width=1280, height=720):
    ...
    return pipeline, camera_matrix, camera_distortion
...
def cameraProcess(pipeline):
    ...
    return filled_depth, depth_image, color_image
...
def main():
    ...
    # Camera calibration data
    pipeline, camera_matrix, camera_distortion = cameraSetting(width, height)
    ...
    while True:
        filled_depth, depth_image, img = cameraProcess(pipeline)

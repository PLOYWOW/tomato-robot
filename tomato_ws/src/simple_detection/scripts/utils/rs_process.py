...
class rs_process:
    def __init__(self,resolution):
        ...
        image_align_hand_color = "/camera/color/image_rect_color" #Topic name #RGB cam
        image_align_hand_depth = "/depth_to_rgb/image_raw" #Realsense cam -> Have depth #2022 use Azure

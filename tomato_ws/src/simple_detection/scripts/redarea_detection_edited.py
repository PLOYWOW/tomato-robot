...
def main():
    ...
    Lmask_MIN = np.array([0,0,0])
    Lmask_MAX = np.array([19,255,255])
    Umask_MIN = np.array([133,0,0])
    Umask_MAX = np.array([180,255,255])
    ...
    while True:
        ...
        black_color = 0
        #h,img_depth,img_depth)) #depth image is 1 channel, color is 3 channels

...
"""
    ...
    Disable dynamixel motor and sending some message for check motion by tsuji in 2022
"""
...
class xarm7_move():
    ...
    def executePick(self,tomatoPose):
        ...
        tomato_calibrate_pos_world = [tomatoPickPos_world[0] - 0.10,
        ...
        tomatoPrePickPos_world = [tomatoPickPos_world[0] - 0.08,
                            tomatoPickPos_world[1],    
        ...
        if rotation != 0:
            ...
            rotatedPickPos_L = [tomatoPickPos_world[0]-0.01,
                            tomatoPickPos_world[1]-0.01,    
                            tomatoPickPos_world[2]]
            rotatedPickPos_R = [tomatoPickPos_world[0]-0.01,
                            tomatoPickPos_world[1]+0.01,    
                            tomatoPickPos_world[2]]
            ...
            tomatoPickPos_world_R = [tomatoPickPos_world[0],
                            tomatoPickPos_world[1]-0.01,    
                            tomatoPickPos_world[2]+0.0]
            tomatoPickPos_world_L = [tomatoPickPos_world[0],
        ...
        tomatoLiftPos_world = [tomatoPickPos_world[0]-0.04,
                            tomatoPickPos_world[1],    
        ...
        time.sleep(0.5)
        tomatoHalfCutPos_world = [tomatoLiftPos_world[0]-0.,
